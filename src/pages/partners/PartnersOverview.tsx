...
const PartnersOverview = () => (
  <>
    <PageHero
      ...
      subtitle="Twelve specialist partners powering the six Infinium units — HW, Vision Intelligence, Monitoring, Energies, Compute and Sustainability — integrated by Infinium Group into a single conglomerate offering."
    />
